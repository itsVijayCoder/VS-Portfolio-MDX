...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className='dark:bg-background w-full bg-white font-sans md:px-10'
      ref={containerRef}
    >
      <div className='mx-auto max-w-7xl px-4 py-10 sm:py-20 md:px-8 lg:px-10'>
        ...
        <p className='max-w-sm text-sm text-neutral-700 md:text-base dark:text-neutral-300'>
          ...
          for the past 1.5 years. Here&apos;s a timeline of my journey.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className='sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:flex-row lg:max-w-sm'>
              <div className='dark:bg-background absolute left-3 flex h-10 w-10 items-center justify-center rounded-full bg-white md:left-3'>
            ...
            <div className='relative w-full pr-1 pl-16 md:pl-4'>
